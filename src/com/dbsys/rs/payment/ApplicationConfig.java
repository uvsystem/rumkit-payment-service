 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.dbsys.rs.payment.repository", "com.dbsys.rs.security.repository"})
@EnableAspectJAutoProxy
@EnableTransactionManagement
@ComponentScan({
	"com.dbsys.rs.payment.service",
